      ...
      <div className="container mx-auto px-4">
          ...
          {vendorCategories.map((category, index) => (
            ...
            >
              <Link href={`/services?category=${category.id}`}>
                <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer h-full border-0 shadow-lg bg-white hover:bg-gradient-to-br hover:from-white hover:to-blue-50">
                  <CardContent className="p-6 text-center relative">
                    ...
                    {/* Icon Container */}
                    <div className={`relative mx-auto mb-4 w-16 h-16 rounded-2xl bg-gradient-to-br ${category.color} flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg`}>
                      <category.icon className="h-8 w-8 text-white drop-shadow-sm" />
                    ...
                    <p className="text-muted-foreground text-xs line-clamp-2 group-hover:text-gray-600">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              size="lg"
              className="px-8 py-4 text-lg font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105"
              asChild
            >
